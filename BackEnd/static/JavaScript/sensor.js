...
function updateCalibrationInputs() {
    $('#reading_1').val(parseFloat(sensorData.reading_1).toFixed(2));
    $('#reading_2').val(parseFloat(sensorData.reading_2).toFixed(3));
    $('#reading_3').val(parseFloat(sensorData.reading_3).toFixed(2));
